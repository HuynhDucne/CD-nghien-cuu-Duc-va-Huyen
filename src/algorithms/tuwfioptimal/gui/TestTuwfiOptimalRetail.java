...
public class TestTuwfiOptimalRetail {
    public static void main(String[] args) throws IOException {
        ...
        String resultFile = "result_TUWFI_optimal_retail_k_" + k + ".txt";
