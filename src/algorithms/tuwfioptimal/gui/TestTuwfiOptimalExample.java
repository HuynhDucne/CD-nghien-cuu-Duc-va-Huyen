...
public class TestTuwfiOptimalExample {
    /**
     * Hàm main này để test ví dụ mẫu trong bài báo
     */
    public static void main(String[] args) throws IOException {

        // probFile là tên file chứa dataset đã được định dạng có xác suất
        String probFile = "example_prob.txt";

        // weightFile là tên file chứa tất cả các item trong dataset và weight của từng item
        String weightFile = "example_weight.txt";
        ...
        String resultFile = "result_TUWFI_optimal_example_k_" + k + ".txt";
