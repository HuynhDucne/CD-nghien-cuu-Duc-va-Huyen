...
/**
 *   Dataset: + Bộ Set chứa tất cả các items trong dataset      -   Type: Set<T1>
...
//    /**
//     * Sắp xếp Lists theo thứ tự tăng dần items
//     */
//    private static <T1> void sortList(List<T1> listItem) {
//        // Ghi đè lại phương thức compare trong Comparator để so sánh các item với nhau
//        listItem.sort(new Comparator<>() {
//            @Override
//            public int compare(T1 item1, T1 item2) {
//                return Double.compare(Double.parseDouble((String) item1), Double.parseDouble((String) item2));
//            }
//        });
//    }
