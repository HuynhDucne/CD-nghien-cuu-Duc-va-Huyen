package testcase.T10I4D100K_dataset;

import algorithms.TUFP.TUFPAlgorithm;
import testcase.retail_dataset.MainTest_K900_Retail;

import java.io.IOException;
import java.io.UnsupportedEncodingException;
import java.net.URL;

public class MainTest_K900_T10I4D100K {
    public static void main(String[] args) throws IOException {

        // filePath là tên file chứa dataset
        String filePath = fileToPath("T10I4D100K.txt");
...
//        System.out.println(tufp.getCupLists().size());
    ...
    public static String fileToPath(String filename) throws UnsupportedEncodingException {
        URL url = MainTest_K900_T10I4D100K.class.getResource(filename);
