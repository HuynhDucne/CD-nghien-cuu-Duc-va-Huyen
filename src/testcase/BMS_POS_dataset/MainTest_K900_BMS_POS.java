package testcase.BMS_POS_dataset;
...
public class MainTest_K900_BMS_POS {
    public static void main(String[] args) throws IOException {

        // filePath là tên file chứa dataset
        String filePath = fileToPath("BMS-POS.txt");
...
//        System.out.println(tufp.getCupLists().size());
    ...
    public static String fileToPath(String filename) throws UnsupportedEncodingException {
        URL url = MainTest_K900_BMS_POS.class.getResource(filename);
