package testcase.retail_dataset;
...
public class MainTest_K900_Retail {
    public static void main(String[] args) throws IOException {

        // filePath là tên file chứa dataset
        String filePath = fileToPath("retail.txt");
...
//        System.out.println(tufp.getCupLists().size());
    ...
    public static String fileToPath(String filename) throws UnsupportedEncodingException {
        URL url = MainTest_K900_Retail.class.getResource(filename);
